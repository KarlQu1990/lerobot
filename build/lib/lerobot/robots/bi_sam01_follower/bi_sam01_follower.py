...
from lerobot.robots.sam01_follower import SAM01Follower
...
class BiSAM01Follower(Robot):
    """
    [Bimanual SO-100 Follower Arms](https://github.com/TheRobotStudio/SO-ARM100) designed by TheRobotStudio
    This bimanual robot can also be easily adapted to use SO-101 follower arms, just replace the sam01Follower class with SO101Follower and sam01FollowerConfig with SO101FollowerConfig.
    """

    config_class = BiSAM01FollowerConfig
    name = "bi_sam01_follower"

    def __init__(self, config: BiSAM01FollowerConfig):
        super().__init__(config)
        self.config = config

        left_arm_config = SAM01FollowerConfig(
        ...
        right_arm_config = SAM01FollowerConfig(
        ...
        self.left_arm = SAM01Follower(left_arm_config)
        self.right_arm = SAM01Follower(right_arm_config)
