...
class SAM01FollowerEndEffector(SAM01Follower):
    """
    SAM01Follower robot with end-effector space control.

    This robot inherits from SAM01Follower but transforms actions from
    end-effector space to joint space before sending them to the motors.
    """

    config_class = SAM01FollowerEndEffectorConfig
    name = "sam01_follower_end_effector"

    def __init__(self, config: SAM01FollowerEndEffectorConfig):
        ...
        self.bus = FeetechMotorsBus(
            ...
            motors={
                ...
                "forearm_roll": Motor(5, "sts3215", MotorNormMode.DEGREES),
                "wrist_roll": Motor(6, "sts3215", MotorNormMode.DEGREES),
                "gripper": Motor(7, "sts3215", MotorNormMode.DEGREES),
            },
        ...
        # Initialize the kinematics module for the sam01 robot
        if self.config.urdf_path is None:
            raise ValueError(
                "urdf_path must be provided in the configuration for end-effector control. "
                "Please set urdf_path in your SAM01FollowerEndEffectorConfig."
            )
