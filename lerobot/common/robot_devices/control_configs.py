...
@ControlConfig.register_subclass("show_position")
@dataclass
class ShowPositionConfig(ControlConfig):
    pass


@ControlConfig.register_subclass("torque_disable")
@dataclass
class TorqueDisableConfig(ControlConfig):
    pass
