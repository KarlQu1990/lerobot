...
@dataclass
class ConfigureMotorConfig:
    port: str = "COM4"
    brand: str = "feetech"
    model: str = "sts3215"
    ID: int = 1
    baudrate: int = 100_0000


@parser.wrap()
def configure_motor(cfg: ConfigureMotorConfig):
    port, brand, model, motor_idx_des, baudrate_des = cfg.port, cfg.brand, cfg.model, cfg.ID, cfg.baudrate
